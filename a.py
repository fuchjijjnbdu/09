...
# Bot Configuration
TELEGRAM_BOT_TOKEN = '7796941897:AAH-RLCXhFCklYpYsF83-MLOCLfbI6F3EMs'
ADMIN_USER_ID = 6874503446 # Replace with your admin user ID
...
async def start(update: Update, context: CallbackContext):
    ...
    message = (
        "*🔥 Welcome to @HYDRAGAMINGOP world 🔥*\n\n"
